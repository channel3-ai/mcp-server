/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d7e542b03ddea5fff1237ed279b238b9)
// Runtime types generated with workerd@1.20260630.1 2026-07-01 nodejs_compat
interface __BaseEnv_Env {
	FREE_RATE_LIMITER: RateLimit;
	prod_DEFAULT_CHANNEL3_API_KEY: string;
	DEFAULT_CHANNEL3_API_KEY: string;
	CHANNEL3_BASE_URL: string;
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").Channel3MCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Channel3MCP";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "prod_DEFAULT_CHANNEL3_API_KEY" | "DEFAULT_CHANNEL3_API_KEY" | "CHANNEL3_BASE_URL">> {}
}
